...
export const metadata: Metadata = {
  title: "Expert Legal Services | Professional Law Firm",
  description: "Trusted law firm providing expert legal representation in corporate law, family law, and criminal defense. Schedule your consultation today.",
  keywords: "law firm, legal services, attorney, lawyer, corporate law, family law, criminal defense, legal consultation",
  metadataBase: new URL("https://lawfirm.com"),
  alternates: {
    canonical: "https://lawfirm.com"
  },
  openGraph: {
    title: "Expert Legal Services | Professional Law Firm",
    description: "Trusted law firm providing expert legal representation in corporate law, family law, and criminal defense.",
    siteName: "Law Firm",
    type: "website"
  },
  twitter: {
